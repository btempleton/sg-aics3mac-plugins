//========================================================================================
//  
//  $File: //ai/ai13/devtech/sdk/public/samplecode/TransformButtons/Source/pluginHandler.cpp $
//
//  $Revision: #5 $
//
...
void pluginShutdown( SPInterfaceMessage *message ) {
	...
	// destroy the dialog
	if (g->transformButtonsDialog) {									
	sADMDialog->Destroy( g->transformButtonsDialog );
	}
