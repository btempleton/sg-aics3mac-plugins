//========================================================================================
//  
//  $File: //ai/ai13/devtech/sdk/public/samplecode/TransformButtons/Source/Common.h $
//
//  $Revision: #7 $
//
...
#define GLOBALSTRUCT
...
#ifdef ADDS_MENU
	AIMenuItemHandle showTransformButtonsDialog;
	...
	ADMDialogRef transformButtonsDialog;
	SPAccessRef accessRef;
	SPBasicSuite *basic;
	AINotifierHandle appStartedNotifier;
