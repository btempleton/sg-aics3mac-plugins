//========================================================================================
//  
//  $File: //ai/ai13/devtech/sdk/public/samplecode/MenuPlay/Source/Common.h $
//
//  $Revision: #6 $
//
 ...
 **/
	...
	AIMenuItemHandle menuPlayAIMenuGroupItem;
		
	AIMenuItemHandle manualUpdateAIMenu;
	AIMenuItemHandle multiDemoAIMenu;
	AIMenuItemHandle checkMeAIMenu;	
		
	AIBoolean checkMeChecked;
	AIBoolean checkMeEnabled;
