//========================================================================================
//  
//  $File: //ai/ai13/devtech/sdk/public/samplecode/SnippetRunner/Source/SDKErrors.h $
//
//  $Revision: #3 $
//
...
namespace aisdk
{
	...
	*/
	...
	/** Reports an assert in an ADM alert then throws exception.
		...
		@see check_assertion
	*/
	void report_assert(const char* message, char* file, int line, bool throwException);
