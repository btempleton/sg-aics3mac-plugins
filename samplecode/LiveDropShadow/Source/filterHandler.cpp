//========================================================================================
//  
//  $File: //ai/ai13/devtech/sdk/public/samplecode/LiveDropShadow/Source/filterHandler.cpp $
//
//  $Revision: #2 $
//
...
// this file contains useful routines for filters
...
//	parms_t orig_parms;
	...
	if ( message->filter == g->filters[ 0 ] ) {
		...
		if ( !parms ) {
			...
			sAIMdMemory->MdMemoryNewHandle ( sizeof(parms_t), ( AIMdMemoryHandle *)&message->parameters );
