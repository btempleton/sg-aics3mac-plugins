...
extern AIErr addMenu( SPInterfaceMessage *message ) {
	...
	const char *pluginCStr = "Fix Black";
...
//	pluginMenuData.groupName = pluginCStr;
	error = sAIMenu->AddMenuItem( message->d.self, menuGroupCStr, &pluginMenuData, kMenuItemWantsUpdateOption, &g->FixBlackMenuItemSelected );
	if ( error ) goto error;
