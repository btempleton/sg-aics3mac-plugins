//========================================================================================
//  
//  $File: //ai/ai13/devtech/sdk/public/samplecode/common/source/reportError.cpp $
//
//  $Revision: #2 $
//
...
#include "plugin.h" //for error constants
...
void AIErrToCString( AIErr error_to_report, char *errorText ) {
	...
	sAIUser->IUAIRealToString ( (float) error_to_report, 0, (unsigned char *)errorText );
...
void CStringToAIErr( char *errorText, AIErr *error_to_report ) {
	...
	sAIUser->IUStringToAIReal( (unsigned char *)errorText, &tempErr );
