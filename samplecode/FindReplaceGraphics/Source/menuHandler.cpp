...
//	long isTrue;
	...
	{
		sAIMenu->SetItemText( message->menuItem, ai::UnicodeString("Hide Find & Replace Graphics") );
	}
	else
	{
		sAIMenu->SetItemText( message->menuItem, ai::UnicodeString("Show Find & Replace Graphics") );
	}
...
extern AIErr addMenu( SPInterfaceMessage *message ) {
	...
	const char *pluginCStr = "Find and Replace Colors";
