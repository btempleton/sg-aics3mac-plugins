//========================================================================================
//  
//  $File: //ai/ai13/devtech/sdk/public/samplecode/TwirlFilter/Source/Common.h $
//
//  $Revision: #6 $
//
...
#ifndef ADDS_LIVE_EFFECT
#define ADDS_LIVE_EFFECT
#endif
...
#ifdef ADDS_LIVE_EFFECT
	AILiveEffectHandle effects[kMaxEffects];
	int numEffects;
#endif
...
extern "C"	AIMatchingArtSuite 		*sAIMatch;
...
#endif
#ifdef	ADDS_LIVE_EFFECT
extern "C"	AILiveEffectSuite *sLiveEffect;
