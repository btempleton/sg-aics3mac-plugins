...
void ICompFont::GetNativeName( ASUnicode* name, ASInt32 maxLength) const
{
	ATEErr error = sCompFont->GetNativeName(fCompFont, name, maxLength);
	if(error) Throw_ATE_Exception(error);
}

void ICompFont::SetNativeName( const ASUnicode* name)
{
	ATEErr error = sCompFont->SetNativeName(fCompFont, name);
	if(error) Throw_ATE_Exception(error);
}

void ICompFont::GetPostScriptName( ASUnicode* name, ASInt32 maxLength) const
{
	ATEErr error = sCompFont->GetPostScriptName_AsUnicode(fCompFont, name, maxLength);
	if(error) Throw_ATE_Exception(error);
}

void ICompFont::GetPostScriptName( char* name, ASInt32 maxLength) const
{
...
ASInt32 ICompFont::GetComponentCount( ) const
{
	ASInt32 ret;
...
ICompFontComponent ICompFont::GetComponent( ASInt32 index) const
{
...
ASInt32 ICompFont::Find( ICompFontComponent component) const
{
	ASInt32 ret;
...
bool ICompFont::RemoveComponent( ASInt32 index)
{
	ATEBool8 ret;
...
ASInt32 ICompFont::AddComponent( ICompFontComponent component)
{
	ASInt32 ret;
...
bool ICompFont::ReplaceComponent( ASInt32 index, ICompFontComponent component)
{
	ATEBool8 ret;
...
void ICompFontClass::GetNativeName( ASUnicode* name, ASInt32 maxLength) const
{
	ATEErr error = sCompFontClass->GetNativeName(fCompFontClass, name, maxLength);
	if(error) Throw_ATE_Exception(error);
}

void ICompFontClass::SetNativeName( const ASUnicode* name)
{
	ATEErr error = sCompFontClass->SetNativeName(fCompFontClass, name);
	if(error) Throw_ATE_Exception(error);
}

ASInt32 ICompFontClass::GetCodes( ASUnicode* codes, ASInt32 maxLength) const
{
	ASInt32 ret;
...
ASInt32 ICompFontClass::SetCodes( const ASUnicode* codes)
{
	ASInt32 ret;
...
ASInt32 ICompFontClass::GetCharacterCount( ) const
{
	ASInt32 ret;
...
bool ICompFontClass::IsCodeInClass( ASUnicode code) const
{
	ATEBool8 ret;
...
ASInt32 ICompFontClassSet::GetSize( ) const
{
	ASInt32 ret;
...
ICompFontClass ICompFontClassSet::Item( ASInt32 nIndex) const
{
	CompFontClassRef ret = 0;
...
ASInt32 ICompFontClassSet::Find( ICompFontClass compFontClass) const
{
	ASInt32 ret;
...
ASInt32 ICompFontClassSet::FindPredefined( CompositeFontClassType predefinedType) const
{
	ASInt32 ret;
...
ASReal ICompFontComponent::GetSize( ) const
{
	ASReal ret;
	ATEErr error = sCompFontComponent->GetSize(fCompFontComponent, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

void ICompFontComponent::SetSize( ASReal size)
{
	ATEErr error = sCompFontComponent->SetSize(fCompFontComponent, size);
	if(error) Throw_ATE_Exception(error);
}

ASReal ICompFontComponent::GetBaseline( ) const
{
	ASReal ret;
	ATEErr error = sCompFontComponent->GetBaseline(fCompFontComponent, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

void ICompFontComponent::SetBaseline( ASReal baseline)
{
	ATEErr error = sCompFontComponent->SetBaseline(fCompFontComponent, baseline);
	if(error) Throw_ATE_Exception(error);
}

ASReal ICompFontComponent::GetHorizontalScale( ) const
{
	ASReal ret;
	ATEErr error = sCompFontComponent->GetHorizontalScale(fCompFontComponent, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

void ICompFontComponent::SetHorizontalScale( ASReal horizontalScale)
{
	ATEErr error = sCompFontComponent->SetHorizontalScale(fCompFontComponent, horizontalScale);
	if(error) Throw_ATE_Exception(error);
}

ASReal ICompFontComponent::GetVerticalScale( ) const
{
	ASReal ret;
	ATEErr error = sCompFontComponent->GetVerticalScale(fCompFontComponent, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

void ICompFontComponent::SetVerticalScale( ASReal verticalScale)
{
	ATEErr error = sCompFontComponent->SetVerticalScale(fCompFontComponent, verticalScale);
	if(error) Throw_ATE_Exception(error);
}
...
ASInt32 ICompFontSet::GetSize( ) const
{
	ASInt32 ret;
...
ICompFont ICompFontSet::Item( ASInt32 nIndex) const
{
	CompFontRef ret = 0;
...
ASInt32 ICompFontSet::Find( ICompFont font) const
{
	ASInt32 ret;
...
bool ICompFontSet::Remove( ASInt32 nIndex)
{
	ATEBool8 ret;
...
ASInt32 ICompFontSet::Add( ICompFont font)
{
	ASInt32 ret;
...
bool ICompFontSet::Replace( ASInt32 nIndex, ICompFont newFont)
{
	ATEBool8 ret;
...
ASInt32 IGlyphRun::GetSize( ) const
{
	ASInt32 ret;
...
ASInt32 IGlyphRun::GetCharacterCount( ) const
{
	ASInt32 ret;
...
ASRealMatrix IGlyphRun::GetMatrix( ) const
{
	ASRealMatrix ret;
	ATEErr error = sGlyphRun->GetMatrix(fGlyphRun, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}
...
ASReal IGlyphRun::GetAscent( ) const
{
	ASReal ret;
	ATEErr error = sGlyphRun->GetAscent(fGlyphRun, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

ASReal IGlyphRun::GetDescent( ) const
{
	ASReal ret;
	ATEErr error = sGlyphRun->GetDescent(fGlyphRun, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

ASReal IGlyphRun::GetTracking( ) const
{
	ASReal ret;
	ATEErr error = sGlyphRun->GetTracking(fGlyphRun, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

ASReal IGlyphRun::GetSpaceGlyphWidth( ) const
{
	ASReal ret;
	ATEErr error = sGlyphRun->GetSpaceGlyphWidth(fGlyphRun, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

ASReal IGlyphRun::GetDistanceToBaseline( ) const
{
	ASReal ret;
	ATEErr error = sGlyphRun->GetDistanceToBaseline(fGlyphRun, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

ASReal IGlyphRun::GetUnderlinePosition( ) const
{
	ASReal ret;
	ATEErr error = sGlyphRun->GetUnderlinePosition(fGlyphRun, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

ASReal IGlyphRun::GetUnderlineThickness( ) const
{
	ASReal ret;
	ATEErr error = sGlyphRun->GetUnderlineThickness(fGlyphRun, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

ASReal IGlyphRun::GetMaxCapHeight( ) const
{
	ASReal ret;
	ATEErr error = sGlyphRun->GetMaxCapHeight(fGlyphRun, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

ASReal IGlyphRun::GetMinCapHeight( ) const
{
	ASReal ret;
	ATEErr error = sGlyphRun->GetMinCapHeight(fGlyphRun, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}
...
ASInt32 IGlyphRun::GetContents( ASUnicode* text, ASInt32 maxLength) const
{
	ASInt32 ret;
...
ASInt32 IGlyphRun::GetContents( char* text, ASInt32 maxLength) const
{
	ASInt32 ret;
...
ASInt32 IMojiKumi::GetName( ASUnicode * name, ASInt32 maxLength) const
{
	ASInt32 ret;
...
ASInt32 IMojiKumi::GetNameSize( ) const
{
	ASInt32 ret;
...
void IMojiKumi::SetName( const ASUnicode * name)
{
...
void IMojiKumi::GetEntry( ASInt32 index, ASReal * minExpansion, ASReal * maxExpansion, ASReal * desiredExpansion) const
{
	ATEErr error = sMojiKumi->GetEntry(fMojiKumi, index, minExpansion, maxExpansion, desiredExpansion);
	if(error) Throw_ATE_Exception(error);
}

void IMojiKumi::SetEntry( ASInt32 index, ASReal minExpansion, ASReal maxExpansion, ASReal desiredExpansion)
{
	ATEErr error = sMojiKumi->SetEntry(fMojiKumi, index, minExpansion, maxExpansion, desiredExpansion);
	if(error) Throw_ATE_Exception(error);
}
...
IMojiKumi IMojiKumiSet::Item( ASInt32 nIndex) const
{
	MojiKumiRef ret = 0;
...
ASInt32 IMojiKumiSet::Find( const IMojiKumi mojiKumi)
{
	ASInt32 ret;
...
ASInt32 IMojiKumiSet::Find( const ASUnicode* name)
{
	ASInt32 ret;
...
ASInt32 IMojiKumiSet::Find( MojikumiTablePredefinedTag tag)
{
	ASInt32 ret;
...
bool IMojiKumiSet::Remove( ASInt32 nIndex)
{
	ATEBool8 ret;
...
ASInt32 IMojiKumiSet::Add( IMojiKumi mojiKumi)
{
	ASInt32 ret;
...
bool IMojiKumiSet::Replace( ASInt32  nIndex, IMojiKumi mojiKumi)
{
	ATEBool8 ret;
...
IMojiKumi IMojiKumiSet::CreateNewMojiKumi( const ASUnicode* name, ASInt32* nIndex)
{
	MojiKumiRef ret = 0;
...
ASRealMatrix ITextFrame::GetMatrix( ) const
{
	ASRealMatrix ret;
	ATEErr error = sTextFrame->GetMatrix(fTextFrame, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

ASInt32 ITextFrame::GetRowCount( ) const
{
	ASInt32 ret;
...
ASInt32 ITextFrame::GetColumnCount( ) const
{
	ASInt32 ret;
...
ASReal ITextFrame::GetRowGutter( ) const
{
	ASReal ret;
	ATEErr error = sTextFrame->GetRowGutter(fTextFrame, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

ASReal ITextFrame::GetColumnGutter( ) const
{
	ASReal ret;
	ATEErr error = sTextFrame->GetColumnGutter(fTextFrame, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

ASReal ITextFrame::GetSpacing( ) const
{
	ASReal ret;
	ATEErr error = sTextFrame->GetSpacing(fTextFrame, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}
...
void ITextFrame::SetRowCount( ASInt32 rowCount)
{
	ATEErr error = sTextFrame->SetRowCount(fTextFrame, rowCount);
	if(error) Throw_ATE_Exception(error);
}

void ITextFrame::SetColumnCount( ASInt32 columnCount)
{
...
void ITextFrame::SetRowGutter( ASReal gutter)
{
	ATEErr error = sTextFrame->SetRowGutter(fTextFrame, gutter);
	if(error) Throw_ATE_Exception(error);
}

void ITextFrame::SetColumnGutter( ASReal gutter)
{
	ATEErr error = sTextFrame->SetColumnGutter(fTextFrame, gutter);
	if(error) Throw_ATE_Exception(error);
}

void ITextFrame::SetSpacing( ASReal spacing)
{
	ATEErr error = sTextFrame->SetSpacing(fTextFrame, spacing);
	if(error) Throw_ATE_Exception(error);
}
...
{
	SpellRef ret = 0;
	ATEErr error = sDocumentTextResources->GetSpell(fDocumentTextResources, pSpellingDirectory, &ret);
	if(error) Throw_ATE_Exception(error);
	return ISpell(ret);
}
...
void IDocumentTextResources::InsertAlternateGlyph( const ASUnicode* theCharacters, const ATEGlyphID glyphID, const char* otFeatureArray, ASInt32 otFeatureCount, const long* otFeatureIndexArray, bool leaveSelected)
{
...
ICharStyle IDocumentTextResources::GetCharStyle( const ASUnicode* pName) const
{
	CharStyleRef ret = 0;
...
IParaStyle IDocumentTextResources::GetParaStyle( const ASUnicode* pName) const
{
	ParaStyleRef ret = 0;
...
ICharStyle IDocumentTextResources::CreateCharStyle( const ASUnicode* pName)
{
	CharStyleRef ret = 0;
...
IParaStyle IDocumentTextResources::CreateParaStyle( const ASUnicode* pName)
{
	ParaStyleRef ret = 0;
...
ICharStyle IDocumentTextResources::CreateCharStyleWithFeatures( const ASUnicode* pName, ICharFeatures pFeatures)
{
	CharStyleRef ret = 0;
...
IParaStyle IDocumentTextResources::CreateParaStyleWithFeatures( const ASUnicode* pName, IParaFeatures pFeatures)
{
	ParaStyleRef ret = 0;
...
bool IDocumentTextResources::RemoveCharStyle( const ASUnicode* pName)
{
	ATEBool8 ret;
...
bool IDocumentTextResources::RemoveParaStyle( const ASUnicode* pName)
{
	ATEBool8 ret;
...
void IDocumentTextResources::SetSmartDoubleQuoteCharacters( ASUnicode openQuote, ASUnicode closeQuote, Language language)
{
	ATEErr error = sDocumentTextResources->SetSmartDoubleQuoteCharacters(fDocumentTextResources, openQuote, closeQuote, language);
	if(error) Throw_ATE_Exception(error);
}

void IDocumentTextResources::SetSmartSingleQuoteCharacters( ASUnicode openQuote, ASUnicode closeQuote, Language language)
{
...
void IDocumentTextResources::GetSmartDoubleQuoteCharacters( ASUnicode* openQuote, ASUnicode* closeQuote, Language language)
{
	ATEErr error = sDocumentTextResources->GetSmartDoubleQuoteCharacters(fDocumentTextResources, openQuote, closeQuote, language);
	if(error) Throw_ATE_Exception(error);
}

void IDocumentTextResources::GetSmartSingleQuoteCharacters( ASUnicode* openQuote, ASUnicode* closeQuote, Language language)
{
...
void IDocumentTextResources::SetInsertionFeaturesAndStyle( const ICharFeatures& pFeatures, const ASUnicode* pStyleName)
{
	ATEErr error = sDocumentTextResources->SetInsertionFeaturesAndStyle(fDocumentTextResources, pFeatures.GetRef(), pStyleName);
	if(error) Throw_ATE_Exception(error);
}

ASReal IDocumentTextResources::GetSuperscriptSize( ) const
{
	ASReal ret;
	ATEErr error = sDocumentTextResources->GetSuperscriptSize(fDocumentTextResources, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

void IDocumentTextResources::SetSuperscriptSize( ASReal value)
{
	ATEErr error = sDocumentTextResources->SetSuperscriptSize(fDocumentTextResources, value);
	if(error) Throw_ATE_Exception(error);
}

ASReal IDocumentTextResources::GetSuperscriptPosition( ) const
{
	ASReal ret;
	ATEErr error = sDocumentTextResources->GetSuperscriptPosition(fDocumentTextResources, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

void IDocumentTextResources::SetSuperscriptPosition( ASReal value)
{
	ATEErr error = sDocumentTextResources->SetSuperscriptPosition(fDocumentTextResources, value);
	if(error) Throw_ATE_Exception(error);
}

ASReal IDocumentTextResources::GetSubscriptSize( ) const
{
	ASReal ret;
	ATEErr error = sDocumentTextResources->GetSubscriptSize(fDocumentTextResources, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

void IDocumentTextResources::SetSubscriptSize( ASReal value)
{
	ATEErr error = sDocumentTextResources->SetSubscriptSize(fDocumentTextResources, value);
	if(error) Throw_ATE_Exception(error);
}

ASReal IDocumentTextResources::GetSubscriptPosition( ) const
{
	ASReal ret;
	ATEErr error = sDocumentTextResources->GetSubscriptPosition(fDocumentTextResources, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

void IDocumentTextResources::SetSubscriptPosition( ASReal value)
{
	ATEErr error = sDocumentTextResources->SetSubscriptPosition(fDocumentTextResources, value);
	if(error) Throw_ATE_Exception(error);
}

ASReal IDocumentTextResources::GetSmallCapSize( ) const
{
	ASReal ret;
	ATEErr error = sDocumentTextResources->GetSmallCapSize(fDocumentTextResources, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

void IDocumentTextResources::SetSmallCapSize( ASReal value)
{
	ATEErr error = sDocumentTextResources->SetSmallCapSize(fDocumentTextResources, value);
	if(error) Throw_ATE_Exception(error);
}
...
ASInt32 IDocumentTextResources::GetGreekingSize( ) const
{
	ASInt32 ret;
...
void IDocumentTextResources::SetGreekingSize( ASInt32 value)
{
...
ASInt32 IArrayApplicationPaintRef::GetSize( ) const
{
	ASInt32 ret;
...
IApplicationPaint IArrayApplicationPaintRef::Item( ASInt32 index) const
{
	ApplicationPaintRef ret = 0;
...
ASInt32 IArrayReal::GetSize( ) const
{
	ASInt32 ret;
...
ASReal IArrayReal::GetFirst( ) const
{
	ASReal ret;
	ATEErr error = sArrayReal->GetFirst(fArrayReal, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

ASReal IArrayReal::GetLast( ) const
{
	ASReal ret;
	ATEErr error = sArrayReal->GetLast(fArrayReal, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

ASReal IArrayReal::Item( ASInt32 index) const
{
	ASReal ret;
	ATEErr error = sArrayReal->Item(fArrayReal, index, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}
...
ASInt32 IArrayBool::GetSize( ) const
{
	ASInt32 ret;
...
bool IArrayBool::Item( ASInt32 index) const
{
	ATEBool8 ret;
...
ASInt32 IArrayInteger::GetSize( ) const
{
	ASInt32 ret;
...
ASInt32 IArrayInteger::GetFirst( ) const
{
	ASInt32 ret;
...
ASInt32 IArrayInteger::GetLast( ) const
{
	ASInt32 ret;
...
ASInt32 IArrayInteger::Item( ASInt32 index) const
{
	ASInt32 ret;
...
ASInt32 IArrayLineCapType::GetSize( ) const
{
	ASInt32 ret;
...
LineCapType IArrayLineCapType::Item( ASInt32 index) const
{
	LineCapType ret;
...
ASInt32 IArrayFigureStyle::GetSize( ) const
{
	ASInt32 ret;
...
FigureStyle IArrayFigureStyle::Item( ASInt32 index) const
{
	FigureStyle ret;
...
ASInt32 IArrayLineJoinType::GetSize( ) const
{
	ASInt32 ret;
...
LineJoinType IArrayLineJoinType::Item( ASInt32 index) const
{
	LineJoinType ret;
...
ASInt32 IArrayWariChuJustification::GetSize( ) const
{
	ASInt32 ret;
...
WariChuJustification IArrayWariChuJustification::Item( ASInt32 index) const
{
	WariChuJustification ret;
...
ASInt32 IArrayStyleRunAlignment::GetSize( ) const
{
	ASInt32 ret;
...
StyleRunAlignment IArrayStyleRunAlignment::Item( ASInt32 index) const
{
	StyleRunAlignment ret;
...
ASInt32 IArrayAutoKernType::GetSize( ) const
{
	ASInt32 ret;
...
AutoKernType IArrayAutoKernType::Item( ASInt32 index) const
{
	AutoKernType ret;
...
ASInt32 IArrayBaselineDirection::GetSize( ) const
{
	ASInt32 ret;
...
BaselineDirection IArrayBaselineDirection::Item( ASInt32 index) const
{
	BaselineDirection ret;
...
ASInt32 IArrayLanguage::GetSize( ) const
{
	ASInt32 ret;
...
Language IArrayLanguage::Item( ASInt32 index) const
{
	Language ret;
...
ASInt32 IArrayFontCapsOption::GetSize( ) const
{
	ASInt32 ret;
...
FontCapsOption IArrayFontCapsOption::Item( ASInt32 index) const
{
	FontCapsOption ret;
...
ASInt32 IArrayFontBaselineOption::GetSize( ) const
{
	ASInt32 ret;
...
FontBaselineOption IArrayFontBaselineOption::Item( ASInt32 index) const
{
	FontBaselineOption ret;
...
ASInt32 IArrayFontOpenTypePositionOption::GetSize( ) const
{
	ASInt32 ret;
...
FontOpenTypePositionOption IArrayFontOpenTypePositionOption::Item( ASInt32 index) const
{
	FontOpenTypePositionOption ret;
...
ASInt32 IArrayUnderlinePosition::GetSize( ) const
{
	ASInt32 ret;
...
UnderlinePosition IArrayUnderlinePosition::Item( ASInt32 index) const
{
	UnderlinePosition ret;
...
ASInt32 IArrayStrikethroughPosition::GetSize( ) const
{
	ASInt32 ret;
...
StrikethroughPosition IArrayStrikethroughPosition::Item( ASInt32 index) const
{
	StrikethroughPosition ret;
...
ASInt32 IArrayParagraphJustification::GetSize( ) const
{
	ASInt32 ret;
...
ParagraphJustification IArrayParagraphJustification::Item( ASInt32 index) const
{
	ParagraphJustification ret;
...
ASInt32 IArrayArrayReal::GetSize( ) const
{
	ASInt32 ret;
...
IArrayReal IArrayArrayReal::Item( ASInt32 index) const
{
	ArrayRealRef ret = 0;
...
ASInt32 IArrayBurasagariType::GetSize( ) const
{
	ASInt32 ret;
...
BurasagariType IArrayBurasagariType::Item( ASInt32 index) const
{
	BurasagariType ret;
...
ASInt32 IArrayPreferredKinsokuOrder::GetSize( ) const
{
	ASInt32 ret;
...
PreferredKinsokuOrder IArrayPreferredKinsokuOrder::Item( ASInt32 index) const
{
	PreferredKinsokuOrder ret;
...
ASInt32 IArrayKinsokuRef::GetSize( ) const
{
	ASInt32 ret;
...
IKinsoku IArrayKinsokuRef::Item( ASInt32 index) const
{
	KinsokuRef ret = 0;
...
ASInt32 IArrayMojiKumiRef::GetSize( ) const
{
	ASInt32 ret;
...
IMojiKumi IArrayMojiKumiRef::Item( ASInt32 index) const
{
	MojiKumiRef ret = 0;
...
ASInt32 IArrayMojiKumiSetRef::GetSize( ) const
{
	ASInt32 ret;
...
IMojiKumiSet IArrayMojiKumiSetRef::Item( ASInt32 index) const
{
	MojiKumiSetRef ret = 0;
...
ASInt32 IArrayTabStopsRef::GetSize( ) const
{
	ASInt32 ret;
...
ITabStops IArrayTabStopsRef::Item( ASInt32 index) const
{
	TabStopsRef ret = 0;
...
ASInt32 IArrayLeadingType::GetSize( ) const
{
	ASInt32 ret;
...
LeadingType IArrayLeadingType::Item( ASInt32 index) const
{
	LeadingType ret;
...
ASInt32 IArrayFontRef::GetSize( ) const
{
	ASInt32 ret;
...
IFont IArrayFontRef::Item( ASInt32 index) const
{
	FontRef ret = 0;
...
ASInt32 IArrayGlyphID::GetSize( ) const
{
	ASInt32 ret;
...
ATEGlyphID IArrayGlyphID::Item( ASInt32 index) const
{
	ATEGlyphID ret;
...
ASInt32 IArrayRealPoint::GetSize( ) const
{
	ASInt32 ret;
...
ASRealPoint IArrayRealPoint::GetFirst( ) const
{
	ASRealPoint ret;
	ATEErr error = sArrayRealPoint->GetFirst(fArrayRealPoint, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

ASRealPoint IArrayRealPoint::GetLast( ) const
{
	ASRealPoint ret;
	ATEErr error = sArrayRealPoint->GetLast(fArrayRealPoint, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

ASRealPoint IArrayRealPoint::Item( ASInt32 index) const
{
	ASRealPoint ret;
	ATEErr error = sArrayRealPoint->Item(fArrayRealPoint, index, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}
...
ASInt32 IArrayRealMatrix::GetSize( ) const
{
	ASInt32 ret;
...
ASRealMatrix IArrayRealMatrix::GetFirst( ) const
{
	ASRealMatrix ret;
	ATEErr error = sArrayRealMatrix->GetFirst(fArrayRealMatrix, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

ASRealMatrix IArrayRealMatrix::GetLast( ) const
{
	ASRealMatrix ret;
	ATEErr error = sArrayRealMatrix->GetLast(fArrayRealMatrix, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

ASRealMatrix IArrayRealMatrix::Item( ASInt32 index) const
{
	ASRealMatrix ret;
	ATEErr error = sArrayRealMatrix->Item(fArrayRealMatrix, index, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}
...
ASReal ICharFeatures::GetFontSize( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sCharFeatures->GetFontSize(fCharFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal ICharFeatures::GetHorizontalScale( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sCharFeatures->GetHorizontalScale(fCharFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal ICharFeatures::GetVerticalScale( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sCharFeatures->GetVerticalScale(fCharFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}
...
ASReal ICharFeatures::GetLeading( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sCharFeatures->GetLeading(fCharFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASInt32 ICharFeatures::GetTracking( bool* isAssigned) const
{
	ASInt32 ret;
	ATEBool8 isAssignedRet;
...
ASReal ICharFeatures::GetBaselineShift( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sCharFeatures->GetBaselineShift(fCharFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal ICharFeatures::GetCharacterRotation( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sCharFeatures->GetCharacterRotation(fCharFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}
...
ASReal ICharFeatures::GetUnderlineOffset( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sCharFeatures->GetUnderlineOffset(fCharFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}
...
ASReal ICharFeatures::GetTsume( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sCharFeatures->GetTsume(fCharFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}
...
ASInt32 ICharFeatures::GetWariChuLineCount( bool* isAssigned) const
{
	ASInt32 ret;
	ATEBool8 isAssignedRet;
...
ASInt32 ICharFeatures::GetWariChuLineGap( bool* isAssigned) const
{
	ASInt32 ret;
	ATEBool8 isAssignedRet;
...
ASReal ICharFeatures::GetWariChuScale( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sCharFeatures->GetWariChuScale(fCharFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal ICharFeatures::GetWariChuSize( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sCharFeatures->GetWariChuSize(fCharFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASInt32 ICharFeatures::GetWariChuWidowAmount( bool* isAssigned) const
{
	ASInt32 ret;
	ATEBool8 isAssignedRet;
...
ASInt32 ICharFeatures::GetWariChuOrphanAmount( bool* isAssigned) const
{
	ASInt32 ret;
	ATEBool8 isAssignedRet;
...
ASInt32 ICharFeatures::GetTCYUpDownAdjustment( bool* isAssigned) const
{
	ASInt32 ret;
	ATEBool8 isAssignedRet;
...
ASInt32 ICharFeatures::GetTCYLeftRightAdjustment( bool* isAssigned) const
{
	ASInt32 ret;
	ATEBool8 isAssignedRet;
...
ASReal ICharFeatures::GetLeftAki( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sCharFeatures->GetLeftAki(fCharFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal ICharFeatures::GetRightAki( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sCharFeatures->GetRightAki(fCharFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}
...
ASReal ICharFeatures::GetLineWidth( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sCharFeatures->GetLineWidth(fCharFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal ICharFeatures::GetMiterLimit( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sCharFeatures->GetMiterLimit(fCharFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal ICharFeatures::GetLineDashOffset( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sCharFeatures->GetLineDashOffset(fCharFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}
...
void ICharFeatures::SetFontSize( ASReal newVal)
{
	ATEErr error = sCharFeatures->SetFontSize(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void ICharFeatures::SetHorizontalScale( ASReal newVal)
{
	ATEErr error = sCharFeatures->SetHorizontalScale(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void ICharFeatures::SetVerticalScale( ASReal newVal)
{
	ATEErr error = sCharFeatures->SetVerticalScale(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}
...
void ICharFeatures::SetLeading( ASReal newVal)
{
	ATEErr error = sCharFeatures->SetLeading(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void ICharFeatures::SetTracking( ASInt32 newVal)
{
	ATEErr error = sCharFeatures->SetTracking(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void ICharFeatures::SetBaselineShift( ASReal newVal)
{
	ATEErr error = sCharFeatures->SetBaselineShift(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void ICharFeatures::SetCharacterRotation( ASReal newVal)
{
	ATEErr error = sCharFeatures->SetCharacterRotation(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}
...
void ICharFeatures::SetUnderlineOffset( ASReal newVal)
{
	ATEErr error = sCharFeatures->SetUnderlineOffset(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}
...
void ICharFeatures::SetTsume( ASReal newVal)
{
	ATEErr error = sCharFeatures->SetTsume(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}
...
void ICharFeatures::SetWariChuLineCount( ASInt32 newVal)
{
	ATEErr error = sCharFeatures->SetWariChuLineCount(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void ICharFeatures::SetWariChuLineGap( ASInt32 newVal)
{
	ATEErr error = sCharFeatures->SetWariChuLineGap(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void ICharFeatures::SetWariChuScale( ASReal newVal)
{
	ATEErr error = sCharFeatures->SetWariChuScale(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void ICharFeatures::SetWariChuSize( ASReal newVal)
{
	ATEErr error = sCharFeatures->SetWariChuSize(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void ICharFeatures::SetWariChuWidowAmount( ASInt32 newVal)
{
	ATEErr error = sCharFeatures->SetWariChuWidowAmount(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void ICharFeatures::SetWariChuOrphanAmount( ASInt32 newVal)
{
...
void ICharFeatures::SetTCYUpDownAdjustment( ASInt32 newVal)
{
	ATEErr error = sCharFeatures->SetTCYUpDownAdjustment(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void ICharFeatures::SetTCYLeftRightAdjustment( ASInt32 newVal)
{
	ATEErr error = sCharFeatures->SetTCYLeftRightAdjustment(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void ICharFeatures::SetLeftAki( ASReal newVal)
{
	ATEErr error = sCharFeatures->SetLeftAki(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void ICharFeatures::SetRightAki( ASReal newVal)
{
	ATEErr error = sCharFeatures->SetRightAki(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}
...
void ICharFeatures::SetLineWidth( ASReal newVal)
{
	ATEErr error = sCharFeatures->SetLineWidth(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void ICharFeatures::SetMiterLimit( ASReal newVal)
{
	ATEErr error = sCharFeatures->SetMiterLimit(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void ICharFeatures::SetLineDashOffset( ASReal newVal)
{
	ATEErr error = sCharFeatures->SetLineDashOffset(fCharFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}
...
ASInt32 ICharStyle::GetName( ASUnicode* pName, ASInt32 maxLength) const
{
	ASInt32 ret;
...
bool ICharStyle::SetName( const ASUnicode* pName)
{
	ATEBool8 ret;
...
ASInt32 ICharStyles::GetSize( ) const
{
	ASInt32 ret;
...
void ICharStyles::MoveStyleTo( ICharStyle pStyle, ASInt32 position)
{
...
void IFind::SetSearchChars( ASUnicode* pSearchChars)
{
	ATEErr error = sFind->SetSearchChars(fFind, pSearchChars);
	if(error) Throw_ATE_Exception(error);
}

void IFind::GetSearchChars( ASUnicode* pSearchChars, ASInt32 length) const
{
	ATEErr error = sFind->GetSearchChars(fFind, pSearchChars, length);
	if(error) Throw_ATE_Exception(error);
}

void IFind::SetReplaceChars( ASUnicode* pSearchChars)
{
	ATEErr error = sFind->SetReplaceChars(fFind, pSearchChars);
	if(error) Throw_ATE_Exception(error);
}

void IFind::GetReplaceChars( ASUnicode* pSearchChars, ASInt32 length) const
{
...
bool IFind::FindAndReplaceAllMatches( ASInt32* pReplaceCount)
{
	ATEBool8 ret;
...
void IFind::GetPreReplaceAllSettings( ASInt32* pCurrentPoint, ASInt32* pStartPoint) const
{
	ATEErr error = sFind->GetPreReplaceAllSettings(fFind, pCurrentPoint, pStartPoint);
	if(error) Throw_ATE_Exception(error);
}

void IFind::RestorePreReplaceAllSettings( const ASInt32 currentPoint, const ASInt32 startPoint)
{
...
void IGlyph::GetOTFeatures( char** otFeatures, long* otFeatureCount, long** otFeatureIndex)
{
...
IGlyph IGlyphs::Item( ASInt32 nIndex) const
{
	GlyphRef ret = 0;
...
void IGlyphs::Remove( ASInt32 nIndex)
{
...
ASInt32 IKinsoku::GetName( ASUnicode* name, ASInt32 maxLength) const
{
	ASInt32 ret;
...
ASInt32 IKinsoku::GetNameSize( ) const
{
	ASInt32 ret;
...
void IKinsoku::SetName( const ASUnicode* name)
{
...
ASInt32 IKinsoku::GetNoStartCharSet( ASUnicode* noStartCharSet, ASInt32 maxLength) const
{
	ASInt32 ret;
...
ASInt32 IKinsoku::GetNoStartCharSetSize( ) const
{
	ASInt32 ret;
...
void IKinsoku::SetNoStartCharSet( const ASUnicode* noStartCharSet)
{
	ATEErr error = sKinsoku->SetNoStartCharSet(fKinsoku, noStartCharSet);
	if(error) Throw_ATE_Exception(error);
}

ASInt32 IKinsoku::GetNoEndCharSet( ASUnicode* noEndCharSet, ASInt32 maxLength) const
{
	ASInt32 ret;
...
ASInt32 IKinsoku::GetNoEndCharSetSize( ) const
{
	ASInt32 ret;
...
void IKinsoku::SetNoEndCharSet( const ASUnicode* noEndCharSet)
{
	ATEErr error = sKinsoku->SetNoEndCharSet(fKinsoku, noEndCharSet);
	if(error) Throw_ATE_Exception(error);
}

ASInt32 IKinsoku::GetNoBreakCharSet( ASUnicode* noBreakCharSet, ASInt32 maxLength) const
{
	ASInt32 ret;
...
ASInt32 IKinsoku::GetNoBreakCharSetSize( ) const
{
	ASInt32 ret;
...
void IKinsoku::SetNoBreakCharSet( const ASUnicode* noBreakCharSet)
{
	ATEErr error = sKinsoku->SetNoBreakCharSet(fKinsoku, noBreakCharSet);
	if(error) Throw_ATE_Exception(error);
}

ASInt32 IKinsoku::GetHangingCharSet( ASUnicode* hangingCharSet, ASInt32 maxLength) const
{
	ASInt32 ret;
...
ASInt32 IKinsoku::GetHangingCharSetSize( ) const
{
	ASInt32 ret;
...
void IKinsoku::SetHangingCharSet( const ASUnicode* hangingCharSet)
{
	ATEErr error = sKinsoku->SetHangingCharSet(fKinsoku, hangingCharSet);
	if(error) Throw_ATE_Exception(error);
}

bool IKinsoku::IsNoStartChar( ASUnicode character) const
{
	ATEBool8 ret;
...
bool IKinsoku::IsNoEndChar( ASUnicode character) const
{
	ATEBool8 ret;
...
bool IKinsoku::IsNoBreakChar( ASUnicode character) const
{
	ATEBool8 ret;
...
bool IKinsoku::IsHangingChar( ASUnicode character) const
{
	ATEBool8 ret;
...
IKinsoku IKinsokuSet::Item( ASInt32 nIndex) const
{
	KinsokuRef ret = 0;
...
ASInt32 IKinsokuSet::Find( IKinsoku kinsoku)
{
	ASInt32 ret;
...
ASInt32 IKinsokuSet::Find( const ASUnicode* name)
{
	ASInt32 ret;
...
ASInt32 IKinsokuSet::Find( KinsokuPredefinedTag tag)
{
	ASInt32 ret;
...
bool IKinsokuSet::Remove( ASInt32 nIndex)
{
	ATEBool8 ret;
...
ASInt32 IKinsokuSet::Add( IKinsoku kinsoku)
{
	ASInt32 ret;
...
bool IKinsokuSet::Replace( ASInt32 nIndex, IKinsoku kinsoku)
{
	ATEBool8 ret;
...
ASReal IParaFeatures::GetFirstLineIndent( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sParaFeatures->GetFirstLineIndent(fParaFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal IParaFeatures::GetStartIndent( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sParaFeatures->GetStartIndent(fParaFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal IParaFeatures::GetEndIndent( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sParaFeatures->GetEndIndent(fParaFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal IParaFeatures::GetSpaceBefore( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sParaFeatures->GetSpaceBefore(fParaFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal IParaFeatures::GetSpaceAfter( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sParaFeatures->GetSpaceAfter(fParaFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}
...
ASInt32 IParaFeatures::GetHyphenatedWordSize( bool* isAssigned) const
{
	ASInt32 ret;
	ATEBool8 isAssignedRet;
...
ASInt32 IParaFeatures::GetPreHyphenSize( bool* isAssigned) const
{
	ASInt32 ret;
	ATEBool8 isAssignedRet;
...
ASInt32 IParaFeatures::GetPostHyphenSize( bool* isAssigned) const
{
	ASInt32 ret;
	ATEBool8 isAssignedRet;
...
ASInt32 IParaFeatures::GetConsecutiveHyphenLimit( bool* isAssigned) const
{
	ASInt32 ret;
	ATEBool8 isAssignedRet;
...
ASReal IParaFeatures::GetHyphenationZone( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sParaFeatures->GetHyphenationZone(fParaFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}
...
ASReal IParaFeatures::GetHyphenationPreference( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sParaFeatures->GetHyphenationPreference(fParaFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal IParaFeatures::GetDesiredWordSpacing( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sParaFeatures->GetDesiredWordSpacing(fParaFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal IParaFeatures::GetMaxWordSpacing( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sParaFeatures->GetMaxWordSpacing(fParaFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal IParaFeatures::GetMinWordSpacing( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sParaFeatures->GetMinWordSpacing(fParaFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal IParaFeatures::GetDesiredLetterSpacing( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sParaFeatures->GetDesiredLetterSpacing(fParaFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal IParaFeatures::GetMaxLetterSpacing( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sParaFeatures->GetMaxLetterSpacing(fParaFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal IParaFeatures::GetMinLetterSpacing( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sParaFeatures->GetMinLetterSpacing(fParaFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal IParaFeatures::GetDesiredGlyphScaling( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sParaFeatures->GetDesiredGlyphScaling(fParaFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}

ASReal IParaFeatures::GetMaxGlyphScaling( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sParaFeatures->GetMaxGlyphScaling(fParaFeatures, &isAssignedRet, &ret);
	if (isAssigned) *isAssigned = isAssignedRet;
	if(error) Throw_ATE_Exception(error);
	return ret;
}

ASReal IParaFeatures::GetMinGlyphScaling( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sParaFeatures->GetMinGlyphScaling(fParaFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}
...
ASReal IParaFeatures::GetAutoLeadingPercentage( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sParaFeatures->GetAutoLeadingPercentage(fParaFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}
...
ASReal IParaFeatures::GetDefaultTabWidth( bool* isAssigned) const
{
	ASReal ret;
	ATEBool8 isAssignedRet;
	ATEErr error = sParaFeatures->GetDefaultTabWidth(fParaFeatures, &isAssignedRet, &ret);
	if(error) Throw_ATE_Exception(error);
	if (isAssigned) *isAssigned = isAssignedRet;
	return ret;
}
...
ASInt32 IParaFeatures::GetAutoTCY( bool* isAssigned) const
{
	ASInt32 ret;
	ATEBool8 isAssignedRet;
...
void IParaFeatures::SetFirstLineIndent( ASReal newVal)
{
	ATEErr error = sParaFeatures->SetFirstLineIndent(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void IParaFeatures::SetStartIndent( ASReal newVal)
{
	ATEErr error = sParaFeatures->SetStartIndent(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void IParaFeatures::SetEndIndent( ASReal newVal)
{
	ATEErr error = sParaFeatures->SetEndIndent(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void IParaFeatures::SetSpaceBefore( ASReal newVal)
{
	ATEErr error = sParaFeatures->SetSpaceBefore(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void IParaFeatures::SetSpaceAfter( ASReal newVal)
{
	ATEErr error = sParaFeatures->SetSpaceAfter(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}
...
void IParaFeatures::SetHyphenatedWordSize( ASInt32 newVal)
{
	ATEErr error = sParaFeatures->SetHyphenatedWordSize(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void IParaFeatures::SetPreHyphenSize( ASInt32 newVal)
{
	ATEErr error = sParaFeatures->SetPreHyphenSize(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void IParaFeatures::SetPostHyphenSize( ASInt32 newVal)
{
	ATEErr error = sParaFeatures->SetPostHyphenSize(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void IParaFeatures::SetConsecutiveHyphenLimit( ASInt32 newVal)
{
	ATEErr error = sParaFeatures->SetConsecutiveHyphenLimit(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void IParaFeatures::SetHyphenationZone( ASReal newVal)
{
	ATEErr error = sParaFeatures->SetHyphenationZone(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}
...
void IParaFeatures::SetHyphenationPreference( ASReal newVal)
{
	ATEErr error = sParaFeatures->SetHyphenationPreference(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void IParaFeatures::SetDesiredWordSpacing( ASReal newVal)
{
	ATEErr error = sParaFeatures->SetDesiredWordSpacing(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void IParaFeatures::SetMaxWordSpacing( ASReal newVal)
{
	ATEErr error = sParaFeatures->SetMaxWordSpacing(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void IParaFeatures::SetMinWordSpacing( ASReal newVal)
{
	ATEErr error = sParaFeatures->SetMinWordSpacing(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void IParaFeatures::SetDesiredLetterSpacing( ASReal newVal)
{
	ATEErr error = sParaFeatures->SetDesiredLetterSpacing(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void IParaFeatures::SetMaxLetterSpacing( ASReal newVal)
{
	ATEErr error = sParaFeatures->SetMaxLetterSpacing(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void IParaFeatures::SetMinLetterSpacing( ASReal newVal)
{
	ATEErr error = sParaFeatures->SetMinLetterSpacing(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void IParaFeatures::SetDesiredGlyphScaling( ASReal newVal)
{
	ATEErr error = sParaFeatures->SetDesiredGlyphScaling(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void IParaFeatures::SetMaxGlyphScaling( ASReal newVal)
{
	ATEErr error = sParaFeatures->SetMaxGlyphScaling(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}

void IParaFeatures::SetMinGlyphScaling( ASReal newVal)
{
	ATEErr error = sParaFeatures->SetMinGlyphScaling(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}
...
void IParaFeatures::SetAutoLeadingPercentage( ASReal newVal)
{
	ATEErr error = sParaFeatures->SetAutoLeadingPercentage(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}
...
void IParaFeatures::SetDefaultTabWidth( ASReal newVal)
{
	ATEErr error = sParaFeatures->SetDefaultTabWidth(fParaFeatures, newVal);
	if(error) Throw_ATE_Exception(error);
}
...
void IParaFeatures::SetAutoTCY( ASInt32 newVal)
{
...
ASErr IParagraph::GetContents( ASUnicode* text, ASInt32 maxLength)
{
	ASErr ret;
...
ASErr IParagraph::GetContents( char* text, ASInt32 maxLength)
{
	ASErr ret;
...
ASInt32 IParaStyle::GetName( ASUnicode* pName, ASInt32 maxLength) const
{
	ASInt32 ret;
...
bool IParaStyle::SetName( const ASUnicode* pName)
{
	ATEBool8 ret;
...
ASInt32 IParaStyles::GetSize( ) const
{
	ASInt32 ret;
...
void IParaStyles::MoveStyleTo( IParaStyle pStyle, ASInt32 position)
{
...
{
	ATEErr error = sSpell->Initialize(fSpell, pSpellingDirectory);
	if(error) Throw_ATE_Exception(error);
}
...
void ISpell::ResumeFrom( const ASInt32 resumePoint)
{
...
ASInt32 ISpell::GetWordListSize( )
{
	ASInt32 ret;
...
void ISpell::GetWordListContents( ASUnicode*   pWordListBuffer, ASInt32    sizeOfBuffer, ASInt32*   pNumberOfWords)
{
	ATEErr error = sSpell->GetWordListContents(fSpell, pWordListBuffer, sizeOfBuffer, pNumberOfWords);
	if(error) Throw_ATE_Exception(error);
}

void ISpell::Replace( ITextRange pRange, const ASUnicode* pCorrection)
{
	ATEErr error = sSpell->Replace(fSpell, pRange.GetRef(), pCorrection);
	if(error) Throw_ATE_Exception(error);
}

void ISpell::AddSelectedToReplaceAllDict( const ASUnicode* pCorrection)
{
...
void ISpell::GetPreReplaceAllSettings( ASInt32* pCurrentPoint, bool* pFoundSentenceEnd) const
{
...
void ISpell::RestorePreReplaceAllSettings( const ASInt32 currentPoint, const bool foundSentenceEnd)
{
...
bool ISpell::AddToUserDictionary( const ASUnicode* pWord)
{
	ATEBool8 ret;
...
void ISpell::DeleteFromUserDictionary( const ASUnicode* pWord)
{
	ATEErr error = sSpell->DeleteFromUserDictionary(fSpell, pWord);
	if(error) Throw_ATE_Exception(error);
}

bool ISpell::WordExistsInUserDictionary( const ASUnicode* pWord)
{
	ATEBool8 ret;
...
ASInt32 IStories::GetSize( ) const
{
	ASInt32 ret;
...
IStory IStories::Item( ASInt32 nIndex) const
{
	StoryRef ret = 0;
...
ITextFrame IStory::GetFrame( ASInt32 frameIndex) const
{
	TextFrameRef ret = 0;
...
void IStory::SetKernAtChar( ASInt32 charIndex, ASInt32 value)
{
	ATEErr error = sStory->SetKernAtChar(fStory, charIndex, value);
	if(error) Throw_ATE_Exception(error);
}

void IStory::GetKern( const ITextRange& textRange, AutoKernType* pAutoKernType, ASInt32* value) const
{
	ATEErr error = sStory->GetKern(fStory, textRange.GetRef(), pAutoKernType, value);
	if(error) Throw_ATE_Exception(error);
}

AutoKernType IStory::GetModelKernAtChar( ASInt32 charIndex, ASInt32* pManualKernValue) const
{
	AutoKernType ret;
...
ITextRange IStory::GetTextRange( ASInt32 start, ASInt32 end) const
{
	TextRangeRef ret = 0;
...
ASReal ITabStop::GetPosition( ) const
{
	ASReal ret;
	ATEErr error = sTabStop->GetPosition(fTabStop, &ret);
	if(error) Throw_ATE_Exception(error);
	return ret;
}

void ITabStop::SetPosition( ASReal position)
{
	ATEErr error = sTabStop->SetPosition(fTabStop, position);
	if(error) Throw_ATE_Exception(error);
}
...
void ITabStop::GetLeader( ASUnicode* leader, ASInt32 maxLength) const
{
	ATEErr error = sTabStop->GetLeader(fTabStop, leader, maxLength);
	if(error) Throw_ATE_Exception(error);
}

void ITabStop::SetLeader( ASUnicode* leader)
{
	ATEErr error = sTabStop->SetLeader(fTabStop, leader);
	if(error) Throw_ATE_Exception(error);
}

ASUnicode ITabStop::GetDecimalCharacter( ) const
{
	ASUnicode ret;
...
void ITabStop::SetDecimalCharacter( ASUnicode decimalChar)
{
...
ASInt32 ITabStops::GetSize( ) const
{
	ASInt32 ret;
...
ITabStop ITabStops::Item( ASInt32 nIndex) const
{
	TabStopRef ret = 0;
...
void ITabStops::Remove( ASInt32 nIndex)
{
...
ASInt32 ITextRange::GetStart( ) const
{
	ASInt32 ret;
...
void ITextRange::SetStart( ASInt32 start)
{
	ATEErr error = sTextRange->SetStart(fTextRange, start);
	if(error) Throw_ATE_Exception(error);
}

ASInt32 ITextRange::GetEnd( ) const
{
	ASInt32 ret;
...
void ITextRange::SetEnd( ASInt32 end)
{
	ATEErr error = sTextRange->SetEnd(fTextRange, end);
	if(error) Throw_ATE_Exception(error);
}

ASInt32 ITextRange::GetSize( ) const
{
	ASInt32 ret;
...
bool ITextRange::SetNamedCharStyle( const ASUnicode* pName)
{
	ATEBool8 ret;
...
bool ITextRange::SetNamedParaStyle( const ASUnicode* pName)
{
	ATEBool8 ret;
...
void ITextRange::SetRange( ASInt32 start, ASInt32 end)
{
...
ASInt32 ITextRange::Move( ASInt32 unit)
{
	ASInt32 ret;
...
void ITextRange::InsertBefore( const char* text, ASInt32 length, IFont insertionFont)
{
	ATEErr error = sTextRange->InsertBefore_AsChar(fTextRange, text, length, insertionFont.GetRef());
	if(error) Throw_ATE_Exception(error);
}

void ITextRange::InsertAfter( const char* text, ASInt32 length, IFont insertionFont)
{
	ATEErr error = sTextRange->InsertAfter_AsChar(fTextRange, text, length, insertionFont.GetRef());
	if(error) Throw_ATE_Exception(error);
}

void ITextRange::InsertBefore( const ASUnicode* text, ASInt32 length)
{
	ATEErr error = sTextRange->InsertBefore_AsUnicode(fTextRange, text, length);
	if(error) Throw_ATE_Exception(error);
}

void ITextRange::InsertAfter( const ASUnicode* text, ASInt32 length)
{
...
ASInt32 ITextRange::GetContents( ASUnicode* text, ASInt32 maxLength) const
{
	ASInt32 ret;
...
ASInt32 ITextRange::GetContents( char* text, ASInt32 maxLength) const
{
	ASInt32 ret;
...
ASInt32 ITextRanges::GetSize( ) const
{
	ASInt32 ret;
...
ASInt32 ITextRanges::GetContents( ASUnicode* text, ASInt32 maxLength) const
{
	ASInt32 ret;
...
ASInt32 ITextRanges::GetContents( char* text, ASInt32 maxLength) const
{
	ASInt32 ret;
...
ITextRange ITextRanges::Item( ASInt32 nIndex) const
{
	TextRangeRef ret = 0;
...
void ITextRanges::Remove( ASInt32 nIndex)
{
...
ASInt32 IWordsIterator::GetTrailingSpaceCount( ) const
{
	ASInt32 ret;
...
ASInt32 IWordsIterator::GetTrailingCount( ) const
{
	ASInt32 ret;
...
ASInt32 IWordsIterator::GetTrailingTerminatingPunctuationCount( ) const
{
	ASInt32 ret;
