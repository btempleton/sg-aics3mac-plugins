...
#define kAIDocumentSuiteVersion10		AIAPI_VERSION(10)

// latest version
#define kAIDocumentSuiteVersion			kAIDocumentSuiteVersion10
...
{
   ASInt32	version;			// kAIDocumentMiPrintRecordVersion
   ASInt32	recordSize;			// sizeof(AIDocumentMiPrintRecord)
   AIRect	paperRect;
   AIRect	imageRect;
