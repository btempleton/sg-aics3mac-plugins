...
public:
	...
	/** Formats a numeric value to a string, using the locale with which this
		instance was created.
	  	...
	  	*/
	ai::UnicodeString& toString(const float value, const ASInt32 precision, ai::UnicodeString& str, bool padToPrecision = false);
	...
	/** Formats a numeric value to a string, using the locale with which this
		instance was created.
			...
			@return The result string (the same string returned in \c str).
	  	*/
	ai::UnicodeString& toString(const ASInt32 value, ai::UnicodeString& str);
	...
	/** Formats a numeric value to a string, using the locale with which this
		instance was created.
			...
			@return The result string (the same string returned in \c str).
	  	*/
	ai::UnicodeString& toString(const double value, const ASInt32 precision, ai::UnicodeString& str, bool padToPrecision = false);
	...
	/** Converts a string to a numeric integer value, if the string contains a
		number formatted according to the locale with which this instance was created.
			...
			@return	 True if the string could be parsed to a valid numeric value, false otherwise.
	  */
	bool parseString(const ai::UnicodeString& str, ASInt32& value);
