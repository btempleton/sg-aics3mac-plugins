...
enum VisitAIColorFlagValues {
	...
	/** When on, the operation is occuring during a modal dialog's preview of interim settings.
		This allows the iterator and/or the callback fuction to skip processing that is only
