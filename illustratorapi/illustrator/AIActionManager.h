...
#define kAIActionManagerSuiteVersion3	AIAPI_VERSION(3)
#define kAIActionManagerSuiteVersion	kAIActionManagerSuiteVersion3
#define kAIActionManagerVersion			kAIActionManagerSuiteVersion

/** @ingroup Notifiers
	Sent when an action execution is completed.
 */
...
typedef unsigned long	ActionParamTypeID;
 ...
 */
typedef unsigned long	ActionParamUnitID;
...
typedef unsigned long	ActionParamKeyID;
...
// delete the VPB
	...
	*/
	...
	ASErr ASAPI (*AIActionGetEnumeratedUS)(AIActionParamValueRef param, ActionParamKeyID key,  ai::UnicodeString& name, ASInt32* value);
	...
	ASErr ASAPI (*AIActionSetEnumeratedUS)(AIActionParamValueRef param, ActionParamKeyID key,  const ai::UnicodeString& name, ASInt32 value);
};
