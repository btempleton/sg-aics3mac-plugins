...
#define kAIAssetMgmtSuiteVersion7		AIAPI_VERSION(7)
#define kAIAssetMgmtSuiteVersion		kAIAssetMgmtSuiteVersion7
...
typedef struct AIAssetMgmtSuite {
    ...
    */
	...
	/** Used internally to update the current document's XMP metadata.
  		...
  		*/
	AIAPI AIErr (*UpdateDynamicMetadata) (const char *mimeType, const char* managedURL /* = NULL */, ASUInt32 metadataSelectors);
