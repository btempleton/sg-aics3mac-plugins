...
#define kAIDictionarySuiteVersion6				AIAPI_VERSION(6)
#define kAIDictionarySuiteVersion				kAIDictionarySuiteVersion6
#define kAIDictionaryVersion					kAIDictionarySuiteVersion

#define kAIDictionaryIteratorSuite				"AI Dictionary Iterator Suite"
#define kAIDictionaryIteratorSuiteVersion1		AIAPI_VERSION(1)
#define kAIDictionaryIteratorSuiteVersion		kAIDictionaryIteratorSuiteVersion1
 ...
 */
typedef struct AIDictionarySuite {
	...
	*/
	...
	/** Retrieves a Unicode string value from a dictionary entry.
			...
			@param value [out] A buffer in which to return the value.
	*/
	AIAPI AIErr (*GetUnicodeStringEntry) ( AIDictionaryRef dictionary, AIDictKey key, ai::UnicodeString& value );
...
*/
typedef struct AIDictionaryIteratorSuite {

	/** Increments the reference count of an iterator.
			@param iterator The iterator object.
		*/
	AIAPI ASInt32 (*AddRef) ( AIDictionaryIterator iterator );
	/** Frees the memory associated with an iterator when it is no
		...
		*/
	AIAPI ASInt32 (*Release) ( AIDictionaryIterator iterator );
	...
	AIAPI ASBoolean (*IsValid) ( AIDictionaryIterator iterator );
