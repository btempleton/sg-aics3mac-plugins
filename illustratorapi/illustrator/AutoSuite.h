...
// automatic acquisition and realeasing of suite pointers. To use these classes
...
public:
	// initialize AutoSuite mechanims on startup or reload specifying the
...
protected:
	char* Name () {return suite::name();}
	long Version () {return suite::version;}
};
