...
ai::UnicodeString::UnicodeString (const char* string, long srcByteLen, 
...
int ai::UnicodeString::compare (const UnicodeString& str) const
{
	int result = sAIUnicodeString->Compare(*this, 0, this->length(), str, 0, str.length());
	return result;
}

int ai::UnicodeString::compare (ai::UnicodeString::size_type pos, 
								ai::UnicodeString::size_type num, const UnicodeString& str) const
{
	int result = sAIUnicodeString->Compare(*this, pos, num, str, 0, str.length());
	return result;
}
...
{
	int result = sAIUnicodeString->Compare(*this, pos, num, str, startOffset, count);
	return result;
}

int ai::UnicodeString::caseCompare (ai::UnicodeString::size_type pos, 
								ai::UnicodeString::size_type num, const UnicodeString& str, 
								ai::UnicodeString::size_type startOffset, ai::UnicodeString::size_type count) const
{
	int result = sAIUnicodeString->CaseCompare(*this, pos, num, str, startOffset, count);
	return result;
}

int ai::UnicodeString::canonicalCompare (const UnicodeString& str) const
{
	int compareResult = 0;
...
int ai::UnicodeString::canonicalCaseCompare (const UnicodeString& str) const
{
	int compareResult = 0;
