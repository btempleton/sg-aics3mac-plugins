...
/** @ingroup Errors See \c #AIXMLElementSuite, \c #AIXMLNodeListSuite.*/
#define kAIXMLIndexSizeErr			'xInd'
/** @ingroup Errors See \c #AIXMLElementSuite */
#define kAIXMLDOMStringSizeErr		'xDSt'
/** @ingroup Errors See \c #AIXMLDocumentSuite */
#define kAIXMLHierarchyRequestErr	'xHer'
/** @ingroup Errors See \c #AIXMLDocumentSuite */
#define kAIXMLWrongDocumentErr		'xDoc'
/** @ingroup Errors See \c #AIXMLElementSuite, \c #AIXMLDocumentSuite */
