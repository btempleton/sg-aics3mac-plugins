...
{
	ai::LocaleID id;
	id = getID(ai::Locale::getLocale(kSystem));
...
{
	ai::LocaleID id;
	id = getID(ai::Locale::getLocale(kApplication));
...
ai::UnicodeString& ai::NumberFormat::toString(const float value, const ASInt32 precision, ai::UnicodeString& str, 
											  bool padToPrecision) 
{
...
ai::UnicodeString& ai::NumberFormat::toString(const ASInt32 value, ai::UnicodeString& str) 
{
...
ai::UnicodeString& ai::NumberFormat::toString(const double value, const ASInt32 precision, ai::UnicodeString& str,
											  bool padToPrecision) 
{
...
bool ai::NumberFormat::parseString(const ai::UnicodeString& str, ASInt32& value) 
{
