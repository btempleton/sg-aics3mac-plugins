...
#define kAI90ArtSuite			kAIArtSuite
#define kAIArtSuiteVersion8		AIAPI_VERSION(8)
#define kAI90ArtSuiteVersion	kAIArtSuiteVersion8
...
/* Illustrator 9.0 Art suite */
typedef struct _AI90ArtSuite {
