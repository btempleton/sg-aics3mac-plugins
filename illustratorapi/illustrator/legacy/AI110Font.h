...
#ifndef __AI110Font__
#define __AI110Font__
...
#define kAIFontSuiteVersion1	AIAPI_VERSION(1)
#define kAI110FontSuiteVersion	kAIFontSuiteVersion1
#define kAI110FontVersion		kAI110FontSuiteVersion
...
struct AI110FontSuite {
	...
	AIAPI AIErr (*FindFont)( char *postscriptName, enum AIFontTechnology fontTechnology, enum AIFaceScript script,
	...
	AIAPI AIErr (*GetDefaultFont)( enum AIFaceScript script, AIFontKey *result);
	...
	AIAPI AIErr (*ImportCompositeFonts)(SPPlatformFileSpecification *source);
