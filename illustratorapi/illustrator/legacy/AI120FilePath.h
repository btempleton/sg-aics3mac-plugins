#ifndef __AI120FilePath__
#define __AI120FilePath__
...
#define kAIFilePathSuiteVersion1	AIAPI_VERSION(1)
#define kAI120FilePathVersion		kAIFilePathSuiteVersion1
...
*/
struct AI120FilePathSuite
{
	/** Creates a new, empty file path object.
			@param filePath [out] A buffer in which to return the
				file path object.
		*/
	...
	/** Reports whether a file path object references a file.
		...
		*/
	AIBool8 AIAPI (*IsEmpty)(const ai::FilePath&);
	...
	/** Adds a file extension to the path of a file path object.
		...
		(Note that this function has no return value.)
			@param ext The extension string.
		   	@param filePath [in, out] The file path object.
		*/
	...
	*/
	...
	/** Sets a file path from a Unicode string.
			@param string The new path, can be a path native to Windows, UNIX, or Mac OS, or a URL.
			@param filePath The file path object.
	*/
	...
	*/
	...
	/** Sets a file path from an \c FSSpec file specification
	...
	*/
	...
	/** Retrieves a file path as an \c FSSpec file specification (in Mac OS only, outside Illustrator core).
