...
/** Undo context types. See @ref UndoContext. */
...
typedef struct {
	...
	/** Specifies the localizable text for Undo and Redo menu items. Illustrator
		uses these strings for the menus as needed.
			...
			@param undoText	The text for the Undo menu.
			@param redoText	The text for the Redo menu.
		 */
