...
/** @ingroup Errors An out-of-range index for a color space was used.
	See \c ai::ColorSpace.*/
#define kColorSpaceBadIndex				'CS!I'
/** @ingroup Errors  See \c ai::ColorSpace. */
...
public:
	...
	*/
	...
	/**	Retrieves the alternate color values in the alternate color space
		...
		*/
	const AIReal* SeparationAltColors(void) const;
	...
	*/
	...
	/** Retrieves the name of a colorant for this color space.
		...
		*/
	ai::UnicodeString NthColorant(int n) const;
