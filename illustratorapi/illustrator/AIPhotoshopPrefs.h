...
//	and preferences.
const uint8 kRasterizeToRGB = 1;
const uint8 kRasterizeToCMYK = 2;
const uint8 kRasterizeToGrayscale = 3;
const uint8 kRasterizeToBitmap = 4;
...
#define kPSDDefaultAntiAliasPref				true
