...
#define kAIColorHarmonySuiteVersion1	AIAPI_VERSION(1)
#define kAIColorHarmonySuiteVersion		kAIColorHarmonySuiteVersion1
...
/** @ingroup Suites
	These functions allow you to use the three Color Harmony dialogs:
		...
		\li The Color Harmony modal dialog that allows a user to modify color schemes and harmony rules,
			and to recolorize art.
...
typedef struct
{
	...
	/** Reports whether the Color Guide palette is currently shown.
	...
	/** Shows the Color Harmony modal dialog with a given swatch group loaded as the only color scheme.
			@param swatchGroup The swatch group object.
			@param forRecolor When true, if some art is selected, the Recolor panel is active,
				the Apply to Art option is checked, and the original colors are reduced
				to the number of colors in the swatch group.
				<br>When false, The Harmony Generation panel is active (in most recent state),
	...
	/** Shows the Color Harmony modal dialog with the Recolor panel active, the Apply to Art option checked,
		all the colors collected into the same bucket, and a given color loaded into the new color.
		 ...
		 */
	AIAPI AIErr (*ShowToTintArt) ( AIColor tintColor, ASBoolean includeWhite );

	/** Shows the Color Harmony modal dialog with the Recolor panel active,
		the Apply to Art option checked, each color from the original art
		in its own bucket, all the buckets active, and all the new colors
	...
	/** Shows the Variations modal dialog with a given swatch group loaded
		as the only color scheme, showing how it would look applied to the
		current art selection, reduced to the number of colors in the swatch group.
			@param swatchGroup The swatch group object.
		*/
	AIAPI AIErr (*ShowVariationsDialog) ( AISwatchGroupRef swatchGroup );
