...
const AIReal* ai::ColorSpace::SeparationAltColors(void) const
{
	const AIReal* altColors = sAIColorSpace->GetSeparationAltColors(*this);
	return altColors;
}
...
ai::UnicodeString ai::ColorSpace::NthColorant(int n) const
{
