...
#define kAIColorConversionVersion8		AIAPI_VERSION(8)
#define kAIColorConversionSuiteVersion	kAIColorConversionVersion8
...
/** @ingroup Errors See \c #AIColorConversionSuite. */
...
typedef struct {
	...
	/** Converts a sample-component color from one color space to another.
		...
		*/
	AIAPI AIErr (*ConvertSampleColorEx) ( const ai::ColorSpace &srcSpace, AISampleComponent *srcColor,
		                                  const ai::ColorSpace &dstSpace, AISampleComponent *dstColor,
