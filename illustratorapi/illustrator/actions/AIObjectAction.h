...
/** @ingroup Actions
	Reflects the selected objects.
		@param #kAIShearSelectionShearAngleKey The amount of shearing.
		@param #kAIShearSelectionAngleKey The angle along which to shear.
...
/** Parameter to \c #kAIShearSelectionAction. The amount of shearing.*/
const ActionParamKeyID kAIShearSelectionShearAngleKey		= 'shag'; // real
/** Parameter to \c #kAIShearSelectionAction. The angle along which to shear.  */
...
/** @ingroup Actions
	Sets object attributes as defined in Attributes palette.
		...
		@param #kAISetObjectAttributesImageMapKey Sets an associated image map.
	*/
...
/** Parameter to \c #kAISetObjectAttributesAction. Sets an associated image map. */
