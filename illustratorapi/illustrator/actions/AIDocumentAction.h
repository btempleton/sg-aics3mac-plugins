...
/** @ingroup Actions
	Makes a new document.
		...
		@param #kAINewDocumentColorModelKey The color model to use.
  		...
  		@param #kAINewDocumentSettingsFileKey The setting template file used to
  			create the new document	(string)
		...
		@param #kAINewDocumentPreviewModeKey  True to allow pixel preview for the document.
...
/** Parameter to \c #kAINewDocumentAction. The template file from
	which the new document will be created, as defined in \c AIDocumentList.h. */
